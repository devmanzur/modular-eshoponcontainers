...
using CrossCuttingConcerns.Core.Exceptions;
...
{
    public abstract class ValueData : IEquatable<ValueData>
    {
        private List<PropertyInfo> _properties;

        private List<FieldInfo> _fields;

        public static bool operator ==(ValueData obj1, ValueData obj2)
        {
